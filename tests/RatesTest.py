...
class RatesTestSuite(unittest.TestCase):
    ...
    def test_Rates_doCalculation(self):
        ...
        Dummy = DummyTransmission()
        Calc.doCalculation(Energie_Einteilchen, Energie_Zweiteilchen, muL, muR, T, Vinput, Koeeffizienten_Zweiteilchen, Dummy)
        self.assertEqual(Calc.doCalculation(Energie_Einteilchen, Energie_Zweiteilchen, muL, muR, T, Vinput, Koeeffizienten_Zweiteilchen, Dummy), 2.0)	
